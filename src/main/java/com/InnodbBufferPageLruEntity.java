...
public class InnodbBufferPageLruEntity {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(poolId, that.poolId) && Objects.equals(lruPosition, that.lruPosition) && Objects.equals(space, that.space) && Objects.equals(pageNumber, that.pageNumber) && Objects.equals(pageType, that.pageType) && Objects.equals(flushType, that.flushType) && Objects.equals(fixCount, that.fixCount) && Objects.equals(isHashed, that.isHashed) && Objects.equals(newestModification, that.newestModification) && Objects.equals(oldestModification, that.oldestModification) && Objects.equals(accessTime, that.accessTime) && Objects.equals(tableName, that.tableName) && Objects.equals(indexName, that.indexName) && Objects.equals(numberRecords, that.numberRecords) && Objects.equals(dataSize, that.dataSize) && Objects.equals(compressedSize, that.compressedSize) && Objects.equals(compressed, that.compressed) && Objects.equals(ioFix, that.ioFix) && Objects.equals(isOld, that.isOld) && Objects.equals(freePageClock, that.freePageClock);
    }
